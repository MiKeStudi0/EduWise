...
import roadmapDataSource from '@/json/devops.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'DevOps Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive DevOps roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/devops';

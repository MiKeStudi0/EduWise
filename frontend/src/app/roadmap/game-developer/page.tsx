...
import roadmapDataSource from '@/json/game-developer.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Game Developer Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Game Developer roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/game-developer';

...
import roadmapDataSource from '@/json/software-architect.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Software Architect Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Software Architect roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/software-architect';

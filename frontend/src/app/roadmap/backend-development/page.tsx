...
import roadmapDataSource from '@/json/backend-development.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Backend Development Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Backend Development roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/backend-development';

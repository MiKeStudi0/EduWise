...
import roadmapDataSource from '@/json/engineering-manager.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Engineering Manager Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Engineering Manager roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/engineering-manager';

...
import roadmapDataSource from '@/json/ai-engineer.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'AI Engineer Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive AI Engineer roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/ai-engineer';

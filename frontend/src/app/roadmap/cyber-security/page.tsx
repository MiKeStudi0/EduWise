...
import roadmapDataSource from '@/json/cyber-security.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Cyber Security Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Cyber Security roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/cyber-security';

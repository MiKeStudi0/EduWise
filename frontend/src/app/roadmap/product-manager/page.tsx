...
import roadmapDataSource from '@/json/product-manager.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Product Manager Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Product Manager roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/product-manager';

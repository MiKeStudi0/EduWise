...
import roadmapDataSource from '@/json/android-development.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Android Development Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Android Development roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/android-development';

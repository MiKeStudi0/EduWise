...
import roadmapDataSource from '@/json/mlops-engineer.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'MLOps Engineer Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive MLOps Engineer roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/mlops-engineer';

...
import roadmapDataSource from '@/json/ux-design.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'UX Design Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive UX Design roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/ux-design';

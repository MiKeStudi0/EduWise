...
import roadmapDataSource from '@/json/ai-data-scientist.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'AI Data Scientist Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive AI Data Scientist roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/ai-data-scientist';

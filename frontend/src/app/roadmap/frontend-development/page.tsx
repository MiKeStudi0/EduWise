...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Frontend Development Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Frontend Development roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/frontend-development';

...
import roadmapDataSource from '@/json/data-analyst.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Data Analyst Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Data Analyst roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/data-analyst';

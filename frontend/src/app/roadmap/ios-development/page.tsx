...
import roadmapDataSource from '@/json/ios-development.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'iOS Development Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive iOS Development roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/ios-development';

...
import roadmapDataSource from '@/json/technical-writer.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Technical Writer Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Technical Writer roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/technical-writer';

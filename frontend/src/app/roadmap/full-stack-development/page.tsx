...
import roadmapDataSource from '@/json/full-stack-development.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Full Stack Development Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Full Stack Development roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/full-stack-development';

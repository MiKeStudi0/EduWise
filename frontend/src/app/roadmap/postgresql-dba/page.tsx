...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'PostgreSQL DBA Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive PostgreSQL DBA roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/postgresql-dba';

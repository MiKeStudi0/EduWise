...
import roadmapDataSource from '@/json/bi-analyst.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'BI Analyst Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive BI Analyst roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/bi-analyst';

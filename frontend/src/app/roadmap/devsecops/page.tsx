...
import roadmapDataSource from '@/json/devsecops.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'DevSecOps Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive DevSecOps roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/devsecops';

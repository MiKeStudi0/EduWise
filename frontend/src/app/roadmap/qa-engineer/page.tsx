...
import roadmapDataSource from '@/json/qa-engineer.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'QA Engineer Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive QA Engineer roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/qa-engineer';

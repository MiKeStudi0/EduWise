...
import roadmapDataSource from '@/json/machine-learning-engineer.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Machine Learning Engineer Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Machine Learning Engineer roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/machine-learning-engineer';

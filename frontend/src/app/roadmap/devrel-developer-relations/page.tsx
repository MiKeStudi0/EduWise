...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'DevRel (Developer Relations) Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive DevRel (Developer Relations) roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/devrel-developer-relations';

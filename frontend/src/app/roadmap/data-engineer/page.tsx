...
import roadmapDataSource from '@/json/data-engineer.json';
...
const pageTitle = seoConfig?.meta_title ?? roadmapConfig?.title ?? 'Data Engineer Roadmap';
const pageDescription =
  seoConfig?.meta_description ??
  roadmapConfig?.description ??
  'Interactive Data Engineer roadmap covering core skills, projects, and best practices.';
const canonicalUrl = seoConfig?.canonical ?? '/roadmap/data-engineer';
